#####Building and installing summary
1. git clone https://dcwbrown/olang
2. cd olang
2. make full
3. make install

#####What it does
'make' starts one of three makefiles: GNUmakefilefor GNU make systems, makefile on BSD systems, and make.cmd on native Windows. 
...
#####32 bit vs 64 bit and Oberon type sizes.
