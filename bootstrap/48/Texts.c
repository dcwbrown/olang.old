...
__TDESC(Texts_PieceDesc, 1, 4) = {__TDFLDS("PieceDesc", 40), {0, 4, 16, 24, -40}};
__TDESC(Texts_ElemMsg, 1, 0) = {__TDFLDS("ElemMsg", 1), {-8}};
__TDESC(Texts_ElemDesc, 1, 4) = {__TDFLDS("ElemDesc", 48), {0, 4, 16, 44, -40}};
__TDESC(Texts_FileMsg, 1, 1) = {__TDFLDS("FileMsg", 48), {28, -16}};
...
__TDESC(Texts_Reader, 1, 4) = {__TDFLDS("Reader", 72), {4, 12, 28, 48, -40}};
__TDESC(Texts_Scanner, 1, 4) = {__TDFLDS("Scanner", 184), {4, 12, 28, 48, -40}};
__TDESC(Texts_Writer, 1, 4) = {__TDFLDS("Writer", 56), {0, 4, 28, 48, -40}};
__TDESC(Texts__1, 1, 5) = {__TDFLDS("", 136), {0, 4, 16, 44, 48, -48}};
