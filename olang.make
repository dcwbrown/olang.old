...
SOURCE     = $(OLANGDIR)/src
OLANG      = olang$(BINEXT)
CSOURCEDIR = $(OLANGDIR)/c-source/$(SIZEALIGN)
...
# bootstraps, use one of the saved unix type C sources in the c-source directory.
	...
	cd $(BUILDDIR); $(OLANGDIR)/$(OLANG) -SFs    -T$(SIZEALIGN) ../../src/compiler/Platform$(PLATFORM).Mod
	cd $(BUILDDIR); $(OLANGDIR)/$(OLANG) -SFsapx -T$(SIZEALIGN) ../../src/compiler/Heap.Mod
	cd $(BUILDDIR); $(OLANGDIR)/$(OLANG) -SFs    -T$(SIZEALIGN) ../../src/compiler/Console.Mod
	...
	cd $(BUILDDIR); $(OLANGDIR)/$(OLANG) -SFsx   -T$(SIZEALIGN) ../../src/compiler/Files.Mod
	...
	cd $(BUILDDIR); $(OLANGDIR)/$(OLANG) -SFs    -T$(SIZEALIGN) ../../src/compiler/vt100.Mod
